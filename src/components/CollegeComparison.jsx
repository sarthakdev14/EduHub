...
const CollegeComparison = () => {
  ...
  { input: { physics: 20, chemistry: 25, maths: 28 }, output: { rank: 30000 } },
    ...
    bitsat: [
  { input: { physics: 130, chemistry: 130, maths: 130 }, output: { rank: 1 } },
  { input: { physics: 128, chemistry: 128, maths: 128 }, output: { rank: 50 } },
  { input: { physics: 126, chemistry: 127, maths: 125 }, output: { rank: 100 } },
  { input: { physics: 124, chemistry: 125, maths: 123 }, output: { rank: 200 } },
  { input: { physics: 122, chemistry: 123, maths: 120 }, output: { rank: 400 } },
  { input: { physics: 120, chemistry: 120, maths: 118 }, output: { rank: 600 } },
  { input: { physics: 118, chemistry: 118, maths: 115 }, output: { rank: 800 } },
  { input: { physics: 115, chemistry: 115, maths: 113 }, output: { rank: 1000 } },
  { input: { physics: 113, chemistry: 113, maths: 110 }, output: { rank: 1200 } },
  { input: { physics: 110, chemistry: 110, maths: 108 }, output: { rank: 1500 } },
  { input: { physics: 108, chemistry: 108, maths: 105 }, output: { rank: 1800 } },
  { input: { physics: 106, chemistry: 106, maths: 103 }, output: { rank: 2000 } },
  { input: { physics: 104, chemistry: 103, maths: 100 }, output: { rank: 2500 } },
  { input: { physics: 102, chemistry: 100, maths: 98 }, output: { rank: 3000 } },
  { input: { physics: 100, chemistry: 98, maths: 95 }, output: { rank: 3500 } },
  { input: { physics: 98, chemistry: 95, maths: 93 }, output: { rank: 4000 } },
  { input: { physics: 96, chemistry: 93, maths: 90 }, output: { rank: 4500 } },
  { input: { physics: 94, chemistry: 90, maths: 88 }, output: { rank: 5000 } },
  { input: { physics: 92, chemistry: 88, maths: 85 }, output: { rank: 5500 } },
  { input: { physics: 90, chemistry: 85, maths: 83 }, output: { rank: 6000 } },
  { input: { physics: 88, chemistry: 83, maths: 80 }, output: { rank: 6500 } },
  { input: { physics: 86, chemistry: 80, maths: 78 }, output: { rank: 7000 } },
  { input: { physics: 84, chemistry: 78, maths: 75 }, output: { rank: 7500 } },
  { input: { physics: 82, chemistry: 75, maths: 73 }, output: { rank: 8000 } },
  { input: { physics: 80, chemistry: 73, maths: 70 }, output: { rank: 8500 } },
  { input: { physics: 78, chemistry: 70, maths: 68 }, output: { rank: 9000 } },
  { input: { physics: 76, chemistry: 68, maths: 65 }, output: { rank: 9500 } },
  { input: { physics: 74, chemistry: 65, maths: 63 }, output: { rank: 10000 } },
  { input: { physics: 72, chemistry: 63, maths: 60 }, output: { rank: 11000 } },
  { input: { physics: 70, chemistry: 60, maths: 58 }, output: { rank: 12000 } },
  { input: { physics: 68, chemistry: 58, maths: 55 }, output: { rank: 13000 } },
  { input: { physics: 66, chemistry: 55, maths: 53 }, output: { rank: 14000 } },
  { input: { physics: 64, chemistry: 53, maths: 50 }, output: { rank: 15000 } },
  { input: { physics: 62, chemistry: 50, maths: 48 }, output: { rank: 16000 } },
  { input: { physics: 60, chemistry: 48, maths: 45 }, output: { rank: 17000 } },
  { input: { physics: 58, chemistry: 45, maths: 43 }, output: { rank: 18000 } },
  { input: { physics: 56, chemistry: 43, maths: 40 }, output: { rank: 19000 } },
  { input: { physics: 54, chemistry: 40, maths: 38 }, output: { rank: 20000 } },
  { input: { physics: 52, chemistry: 38, maths: 35 }, output: { rank: 21000 } },
  { input: { physics: 50, chemistry: 35, maths: 33 }, output: { rank: 22000 } },
  { input: { physics: 48, chemistry: 33, maths: 30 }, output: { rank: 23000 } },
  { input: { physics: 46, chemistry: 30, maths: 28 }, output: { rank: 24000 } },
  { input: { physics: 44, chemistry: 28, maths: 25 }, output: { rank: 25000 } },
  { input: { physics: 42, chemistry: 25, maths: 23 }, output: { rank: 26000 } },
  { input: { physics: 40, chemistry: 23, maths: 20 }, output: { rank: 27000 } },
  { input: { physics: 38, chemistry: 20, maths: 18 }, output: { rank: 28000 } },
  { input: { physics: 36, chemistry: 18, maths: 15 }, output: { rank: 29000 } },
  { input: { physics: 34, chemistry: 15, maths: 13 }, output: { rank: 30000 } },
  { input: { physics: 32, chemistry: 13, maths: 10 }, output: { rank: 31000 } },
  { input: { physics: 30, chemistry: 10, maths: 8 }, output: { rank: 32000 } },
  { input: { physics: 28, chemistry: 8, maths: 5 }, output: { rank: 33000 } },
  { input: { physics: 26, chemistry: 5, maths: 3 }, output: { rank: 35000 } },
  { input: { physics: 24, chemistry: 3, maths: 2 }, output: { rank: 40000 } },
  { input: { physics: 22, chemistry: 2, maths: 1 }, output: { rank: 45000 } },
  { input: { physics: 20, chemistry: 1, maths: 0 }, output: { rank: 50000 } },
],
  };
  ...
  const collegeData = {
    ...
    bitsat: [
    { name: "BITS Pilani - CSE", cutoff: 450, category: "BITS Pilani" },
    { name: "BITS Pilani - ECE", cutoff: 1500, category: "BITS Pilani" },
    { name: "BITS Pilani - Electrical", cutoff: 2500, category: "BITS Pilani" },
    { name: "BITS Pilani - Mechanical", cutoff: 4000, category: "BITS Pilani" },

    { name: "BITS Goa - CSE", cutoff: 1000, category: "BITS Goa" },
    { name: "BITS Goa - ECE", cutoff: 2500, category: "BITS Goa" },
    { name: "BITS Goa - Electrical", cutoff: 3500, category: "BITS Goa" },
    { name: "BITS Goa - Mechanical", cutoff: 5000, category: "BITS Goa" },

    { name: "BITS Hyderabad - CSE", cutoff: 1500, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - ECE", cutoff: 3000, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Electrical", cutoff: 4000, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Mechanical", cutoff: 5500, category: "BITS Hyderabad" },

    { name: "BITS Pilani - CSE", cutoff: 500, category: "BITS Pilani" },
    { name: "BITS Pilani - ECE", cutoff: 1800, category: "BITS Pilani" },
    { name: "BITS Pilani - Electrical", cutoff: 2700, category: "BITS Pilani" },
    { name: "BITS Pilani - Mechanical", cutoff: 4200, category: "BITS Pilani" },

    { name: "BITS Goa - CSE", cutoff: 1100, category: "BITS Goa" },
    { name: "BITS Goa - ECE", cutoff: 2700, category: "BITS Goa" },
    { name: "BITS Goa - Electrical", cutoff: 3700, category: "BITS Goa" },
    { name: "BITS Goa - Mechanical", cutoff: 5200, category: "BITS Goa" },

    { name: "BITS Hyderabad - CSE", cutoff: 1600, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - ECE", cutoff: 3200, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Electrical", cutoff: 4200, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Mechanical", cutoff: 5700, category: "BITS Hyderabad" },

    { name: "BITS Pilani - CSE", cutoff: 600, category: "BITS Pilani" },
    { name: "BITS Pilani - ECE", cutoff: 1900, category: "BITS Pilani" },
    { name: "BITS Pilani - Electrical", cutoff: 2800, category: "BITS Pilani" },
    { name: "BITS Pilani - Mechanical", cutoff: 4300, category: "BITS Pilani" },

    { name: "BITS Goa - CSE", cutoff: 1200, category: "BITS Goa" },
    { name: "BITS Goa - ECE", cutoff: 2800, category: "BITS Goa" },
    { name: "BITS Goa - Electrical", cutoff: 3800, category: "BITS Goa" },
    { name: "BITS Goa - Mechanical", cutoff: 5300, category: "BITS Goa" },

    { name: "BITS Hyderabad - CSE", cutoff: 1700, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - ECE", cutoff: 3300, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Electrical", cutoff: 4300, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Mechanical", cutoff: 5800, category: "BITS Hyderabad" },

    { name: "BITS Pilani - CSE", cutoff: 700, category: "BITS Pilani" },
    { name: "BITS Pilani - ECE", cutoff: 2000, category: "BITS Pilani" },
    { name: "BITS Pilani - Electrical", cutoff: 2900, category: "BITS Pilani" },
    { name: "BITS Pilani - Mechanical", cutoff: 4400, category: "BITS Pilani" },

    { name: "BITS Goa - CSE", cutoff: 1300, category: "BITS Goa" },
    { name: "BITS Goa - ECE", cutoff: 2900, category: "BITS Goa" },
    { name: "BITS Goa - Electrical", cutoff: 3900, category: "BITS Goa" },
    { name: "BITS Goa - Mechanical", cutoff: 5400, category: "BITS Goa" },

    { name: "BITS Hyderabad - CSE", cutoff: 1800, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - ECE", cutoff: 3400, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Electrical", cutoff: 4400, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Mechanical", cutoff: 5900, category: "BITS Hyderabad" },

    { name: "BITS Pilani - CSE", cutoff: 800, category: "BITS Pilani" },
    { name: "BITS Pilani - ECE", cutoff: 2100, category: "BITS Pilani" },
    { name: "BITS Pilani - Electrical", cutoff: 3000, category: "BITS Pilani" },
    { name: "BITS Pilani - Mechanical", cutoff: 4500, category: "BITS Pilani" },

    { name: "BITS Goa - CSE", cutoff: 1400, category: "BITS Goa" },
    { name: "BITS Goa - ECE", cutoff: 3000, category: "BITS Goa" },
    { name: "BITS Goa - Electrical", cutoff: 4000, category: "BITS Goa" },
    { name: "BITS Goa - Mechanical", cutoff: 5500, category: "BITS Goa" },

    { name: "BITS Hyderabad - CSE", cutoff: 1900, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - ECE", cutoff: 3500, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Electrical", cutoff: 4500, category: "BITS Hyderabad" },
    { name: "BITS Hyderabad - Mechanical", cutoff: 6000, category: "BITS Hyderabad" },
    ],
  };
